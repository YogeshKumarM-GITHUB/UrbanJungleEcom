    ...
    return (
        <div className="mt-20 relative bg-cover bg-center h-[500px] w-full" style={{ backgroundImage: `url(${flashsale})` }}>
            ...
            <div className='absolute text-white   z-40 flex flex-col items-center justify-center top-[150px] left-1/2 transform -translate-x-1/2 mt-4'>
                <p className='text-[42px] text-center'>Flash Sale: Up to 50% Off <br/> On Select Items!</p>
                <p className='text-[16px] text-center'>Don’t miss out on our flash sale event! For a limited time, enjoy up to 50% <br/> off on a selection of our best-selling products.</p>
